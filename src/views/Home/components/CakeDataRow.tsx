  ...
  return (
    <Grid>
      <Flex flexDirection="column" style={{ gridArea: 'a' }}>
        ...
        {circulatingSupply ? (
          <Balance decimals={0} lineHeight="1.1" fontSize="24px" bold value={4899329} />
        ) : (
      ...
      <StyledColumn noMobileBorder style={{ gridArea: 'b' }}>
        ...
        {cakeSupply ? (
          <Balance decimals={0} lineHeight="1.1" fontSize="24px" bold value={5000000} />
        ) : (
          <>
            <div ref={observerRef} />
            <Skeleton height={24} width={126} my="4px" />
      ...
      <StyledColumn noMobileBorder style={{ gridArea: 'c' }}>
        ...
        <Balance decimals={0} lineHeight="1.1" fontSize="24px" bold value={100671} />
      </StyledColumn>      
    </Grid>
  )
}
